...
Profile: MyParentProfile_Working
Parent: Composition
Id: my-parent-profile-working
...
// child profile just commented out to "merge" parent and child content
...
Instance: MyChildInstance-Working
InstanceOf: my-parent-profile-working
Usage: #example
